...
13. Produce the report.
   ...
   - Include the profit transmission chain, observation posts, and cycle timeline.
   - Include a database-style tracking section for ongoing updates.
...
- profit/order transmission chain (how demand signals propagate upstream)
